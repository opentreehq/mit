...
// DepsCommand returns the deps subcommand.
func DepsCommand() *cli.Command {
	return &cli.Command{
		Name:        "deps",
		Usage:       "Analyze inter-repo dependencies",
		Description: "Scans package.json and docker-compose.yml files to find cross-repo dependencies.",
		Action:      depsAction,
	}
}
...
func depsAction(ctx context.Context, cmd *cli.Command) error {
	dir, err := os.Getwd()
	if err != nil {
		return err
	}
